...
main() {
    ...
    tag=intragpu-both_torch-mixtral-loogle-32k_64_512
    input_len=1024
    for qps in 1 0.2 0.5 0.75; do
   ...
   # --cmd="
	vllm bench serve --port 10003 \
          ...
          --goodput tpot:100 \
          --dataset-name custom \
          --dataset-path /workspace/loogle_custom_prompts_516_trimmed_32000.jsonl \
          ...
          rm -rf /workspace/vllm_intragpu/examples/online_serving/intragpu_serving/num_gpu_blocks.pkl
          sleep 2
